...
Video demonstrations showing sensor function, PINN architecture, and experimental validation.

Software (SW) structure diagrams illustrating code modules and data flow.


> Note: Source code and datasets will be released on GitHub in a follow-up update. For immediate access, please contact the corresponding author.
...
1. Code Organization & Annotation

We will refactor the entire code, add detailed comments, and standardize file naming.



2. Filtering for Publication

Only parts directly related to the RA-L manuscript will be included to avoid confusion.



3. Ongoing Development

As the sensor evolves toward a commercial-ready product, we will keep the repository updated.
...
The code is still under active optimization and lacks final documentation.

Our goal extends beyond a single publication; we aim to develop a robust product.
...
We appreciate your interest and will respond promptly to facilitate reproducibility and collaboration.
