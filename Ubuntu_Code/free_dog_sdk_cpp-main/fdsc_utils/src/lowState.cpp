...
{
    lowState::lowState() {
            // subscriber foot_force_data 
            foot_force_subscriber = nh.subscribe("/foot_force_data", 20, &lowState::footForceCallback, this);
    }
    ...
    void lowState::footForceCallback(const std_msgs::UInt16MultiArray::ConstPtr& msg) {
